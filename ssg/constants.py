...
xccdf_header = f"{xml_version}<xccdf>"
xccdf_footer = "</xccdf>"
...
OSCAP_DS_STRING = f"xccdf_{OSCAP_VENDOR}.content_benchmark_"
OSCAP_PROFILE = f"xccdf_{OSCAP_VENDOR}.content_profile_"
OSCAP_GROUP = f"xccdf_{OSCAP_VENDOR}.content_group_"
OSCAP_RULE = f"xccdf_{OSCAP_VENDOR}.content_rule_"
OSCAP_GROUP_PCIDSS = f"xccdf_{OSCAP_VENDOR}.content_group_pcidss-req"
OSCAP_GROUP_VAL = f"xccdf_{OSCAP_VENDOR}.content_group_values"
OSCAP_GROUP_NON_PCI = f"xccdf_{OSCAP_VENDOR}.content_group_non-pci-dss"
OSCAP_PATH = "oscap"
